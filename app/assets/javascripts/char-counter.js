var myCounter = (function(){
	...
	var maxLength, $counter, $textarea; 
	...
	var add = function(textarea,counter,length){
		
		 maxLength = length || 140;
	     $counter = $(counter);
	     $textarea = $(textarea);

		console.log('inside ' + this.name);
		console.log($counter.toString + " - " + $textarea + ' ' + maxLength);
	...
	//monitor textarea
	var check = function(){
		availableChars = maxLength - $textarea.val().length 
		console.log(availableChars);

		$counter.text(availableChars);
	};
...
$(function () {
	myCounter.add('.micropost-textbox textarea','#char-counter', 140);
});
